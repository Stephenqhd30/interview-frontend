...
export async function listFavourQuestionByPageUsingPost(
  ...
  return request<API.BaseResponsePageQuestionVO_>('/api/questionFavour/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function listMyFavourQuestionByPageUsingPost(
  ...
  return request<API.BaseResponsePageQuestionVO_>('/api/questionFavour/my/list/page', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
